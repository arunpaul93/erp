...
export default function StrategyCanvas({ value, onChange, fullScreen, selfName }: { value?: CanvasData | null, onChange?: (data: CanvasData) => void, fullScreen?: boolean, selfName?: string }) {
  ...
  return (
  <div ref={containerRef} className={`rounded-xl border border-gray-800 bg-gray-900 p-4 overflow-hidden ${fullScreen ? 'relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen' : 'w-full'}`}>
